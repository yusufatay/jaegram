...
class _SettingsScreenNewState extends ConsumerState<SettingsScreenNew> 
    ...
    return _buildGlassSection(
      ...
      children: [
        _buildModernListTile(
          ...
          subtitle: 'Instagram profilinizi görüntüleyin',
    ...
    return _buildGlassSection(
      ...
      children: [
        _buildModernListTile(
          ...
          subtitle: 'Kullanıcı verilerinizi güncelleyin',
  ...
  Future<void> _openInstagramProfile(BuildContext context, dynamic user) async {
    try {
      // Instagram kullanıcı adını al
      String? instagramUsername;
      
      // Önce user'ın instagram username'ini kontrol et
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Instagram profili açılırken hata oluştu'),
            backgroundColor: Colors.red,
          ),
        );
      }
