...
class _LoginScreenState extends ConsumerState<LoginScreen> with TickerProviderStateMixin {
        ...
        child: Column(
          children: [
            ...
            ShaderMask(
              ...
              child: const Text(
                'JAEGram', // Uygulama adı güncellendi
                style: TextStyle(
                  fontSize: 44,
  ...
  Widget _buildTextField({
    ...
    return Container(
      decoration: BoxDecoration(
        color: Colors.white, // Set background to white for readability
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(
            ...
            color: Colors.grey[600], // Slightly darker hint for contrast
          ),
        ),
  ...
  Widget _buildLoginButtons() {
    return Column(
      children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: _acceptedKvkk
                    ? [
                        BoxShadow(
                          color: const Color(0xFF8134AF).withOpacity(0.4),
                          blurRadius: 20,
                          offset: const Offset(0, 8),
                        ),
                      ]
        ...
        // Login Button (only Instagram)
        ElevatedButton(
          onPressed: _isInstagramLoading || !_acceptedKvkk ? null : _handleInstagramLogin,
          child: _isInstagramLoading
          ...
          child: Column(
            children: [
              ...
              const Expanded(
                child: SingleChildScrollView(
                  child: Text(
                    'Instagram Puan uygulaması, kullanıcıların kişisel verilerinin korunması konusunda hassas davranır.\n\n'
                    '• Toplanan veriler sadece hizmet sunumu için kullanılır\n'
                    '• Veriler üçüncü şahıslarla paylaşılmaz\n'
                    '• Güvenli şifreleme yöntemleri kullanılır\n'
                    '• KVKK kapsamındaki haklarınızı kullanabilirsiniz\n\n'
